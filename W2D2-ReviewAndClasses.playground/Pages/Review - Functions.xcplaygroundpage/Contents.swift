...
func describeSpeed(kph: Double) {
    ...
    if kph > 100 {
        print("slow down \(kph) km/h is too fast")
    } else if kph > 0 {
        print("We are moving at \(kph) km/h")
    } else {
        print("We are not moving")
    }
}
...
func speedDescription(kph:Double) -> String {
    if kph > 100 {
        return "Slow down \(kph) is too fast"
    } else if kph > 0 {
        return "we are moving at \(kph)"
    } else {
        return "We are not moving"
    }
}
